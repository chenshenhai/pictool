(function (global, factory) {
  ...
  typeof define === 'function' && define.amd ? define('Pictool', factory) :
  (global = global || self, global.Pictool = factory());
              ...
              navList: processMenuConfig.menu.map(function (conf) {
                  return {
                      ...
                      feedback: function () {
                          ...
                          var originImgData = schemaParser.parseImageData(sketchSchema);
                          var imageData = browser.util.imageData2DigitImageData(originImgData);
                          return new Promise(function (resolve, reject) {
