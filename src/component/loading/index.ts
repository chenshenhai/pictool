...
export class Progress {
  ...
  private _render() {
    ...
    const html = `
      <div class="pictool-component-loading" style="${styleAttr}">
  ...
  show() {
    this._component.classList.remove('loading-hidden');
  }

  hide() {
    this._component.classList.add('loading-hidden');
  }
  ...
  private _triggerEvent() {
    ...
    const outer = component.querySelector('.pictool-loading-outer');
    const inner = component.querySelector('.pictool-loading-inner');
