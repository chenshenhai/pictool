...
import { filterPersonImageData, filterPersonWhiteSkinImageData } from '../../core/filter/person';
import { asyncWorker } from '../../util/worker';
import schemaParser from '../schema-parser';

export const filterPerson = function(opts: FilterOpts): Promise<any> {
  return new Promise(function(resolve, reject) {
    asyncWorker(filterPersonWhiteSkinImageData, opts).then(function(result: ImageData) {
